(function () {
  ...
  const ZONE_DATA = {
    walls: {
      title: 'Стены',
      body: 'Материал, толщина и проходки определяют, как звук проходит через стену.',
      svg: () => `
    ...
    ceiling: {
      title: 'Потолок',
      body: 'Шум сверху идёт через перекрытие или обходит его по стенам.',
      svg: () => `
    ...
    floor: {
      title: 'Пол',
      body: 'Удар и вибрация передаются через стяжку и перекрытие.',
      svg: () => `
    ...
    joints: {
      title: 'Примыкания',
      body: 'Стыки и проходки часто становятся слабым звеном в конструкции.',
      svg: () => `
    ...
    engineering: {
      title: 'Вентиляция и инженерные системы',
      body: 'Шахты, трубы и вентиляция проводят звук между помещениями.',
      svg: () => `
    ...
    equipment: {
      title: 'Оборудование',
      body: 'Техника и инженерные агрегаты создают шум и вибрацию в помещении.',
      svg: () => `
    ...
    acoustics: {
      ...
      body: 'Отражения и геометрия влияют на разборчивость речи и комфорт звука.',
      svg: () => `
